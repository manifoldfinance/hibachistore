...
contract HibachiShopArber is IUniswapV2Callee {
        ...
        )
    {
        ...
        if (withHibachi) {
            (leftProfit, numHibachi) = LotterySwapInterface(governance.lotterySwap()).swapEthToDai{ value: (profit) }(
        ...
        )
    {
        ...
        if (WithArb) {
            ...
            if (withHibachi) {
                ...
                (numTokensObtained, numHibachi) = LotterySwapInterface(governance.lotterySwap()).swapTokenToDai(
                    msg.sender, // Sender of the swap
                    msg.sender, // Buy candies for addresss
                    token, // token address
    ...
    function _TokenToEthHibachi(
        ...
        if (withHibachi) {
            ...
            (leftProfit, numHibachi) = LotterySwapInterface(governance.lotterySwap()).swapTokenToDai(
                msg.sender,
                msg.sender,
                token,
                profit,
        ...
        )
    {
        ...
        if (WithArb) {
            ...
            if (withHibachi) {
                (numEthObtained, numHibachi) = LotterySwapInterface(governance.lotterySwap()).swapEthToDai{
    ...
    event Report(uint256 tokenBrought, uint256 profit, uint256 candiesBrought);
